(window.mobileUtil = (function(a, b) {
  ...
  var c = navigator.userAgent,
    d = /android|adr/gi.test(c),
    e = /iphone|ipod|ipad/gi.test(c) && !d,
    f = d || e;
  return {
    isAndroid: d,
    isIos: e,
    ...
    fixScreen: function() {
      ...
      var d = Math.min,
        g = b.querySelector('meta[name="viewport"]'),
        h = g ? g.content : "",
        i = h.match(/initial\-scale=([\d\.]+)/),
        j = h.match(/width=([^,\s]+)/);
      if (!g) {
        var k,
          l = b.documentElement,
          m = l.dataset.mw,
          n = e ? d(a.devicePixelRatio, 3) : 1,
          o = 1;
        l.removeAttribute("data-mw"),
          (l.dataset.dpr = n),
          (g = b.createElement("meta")),
          (g.name = "viewport"),
          (g.content = c(o)),
          l.firstElementChild.appendChild(g);
        var p = function() {
        ...
        var q = parseInt(j[1]),
          ...
          s = a.outerWidth || r,
          t = a.screen.width || r,
          u = a.screen.availWidth || r,
          v = a.innerHeight || q,
          x = a.outerHeight || v,
          y = a.screen.height || v,
          z = a.screen.availHeight || v,
          A = d(r, s, t, u, v, x, y, z),
          o = A / q;
        1 > o && (g.content = h + "," + c(o));
      }
